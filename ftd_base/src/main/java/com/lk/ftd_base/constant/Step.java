...
//        stepMap.put(STEP_TONGUE_BOTTOM, new Step(STEP_TONGUE_BOTTOM));
        ...
        for (int i = 0; i < size; i++) {
            int typeId = Constant.TYPES.keyAt(i);
    ...
    public Step(int typeId) {
        ...
        switch (this.typeId) {
            case Constant.FACE:
                ...
                tipResID = 0;
                fileName = com.lk.ftd_base.constant.Constant.FILE_NAME_FACE;
            ...
            case Constant.TONGUE_TOP:
                ...
                fileName = com.lk.ftd_base.constant.Constant.FILE_NAME_TONGUE_TOP;
                tipText = "正对白光，张大嘴巴，放松伸出舌头";
                title = "舌诊";
                break;
            case Constant.TONGUE_BOTTOM:
                dashedResID = R.drawable.xuxian_shedi;
                tipResID = R.drawable.tip_tongue_bottom;
                fileName = com.lk.ftd_base.constant.Constant.FILE_NAME_TONGUE_BOTTOM;
